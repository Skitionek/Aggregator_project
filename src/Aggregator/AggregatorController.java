...
public class AggregatorController extends HouseController {
    ...
    public static final String TOPIC = Aggregator.TOPIC;
    ...
    public static final String RESET = Aggregator.RESET;
            ...
            public void messageReceived(String[] msg) {
                ...
                switch (msg[0]) {
                    ...
                    case ACTIVATE:
                        ...
                        try {
                            //homeName,flexibility_time
                            if (act_type == RegulationType.DOWN) state = State.MAX;
                            if (act_type == RegulationType.UP) state = State.MIN;
                            reply = client.callSync(ACTIVATE, new String[] {
                                "ACC"
                            });
                        } catch (Exception e) {
                        ...
                        break;
                    default:
                        System.out.println("This function was not implemented - possible transmission error.");
                }
            }
        };
        // subscribe to flexibility topic
        System.out.println("Subscribing to aggregator service.");
        pubSubClient.subscribe(TOPIC, flexibilityListener);
    }
